...
function behavior:Utility(botBrain)
	...
	-- When we have a debuff that gets stronger as we take more damage, we should increase the threat generated by damage taken
	if UnitUtils.ShouldAvoidDamage(unitSelf) then
		behaviorLib.nRecentDamageMul = 4; -- default 0.35
		--TODO: Also increase fear of enemies
	else
